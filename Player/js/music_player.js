...
function lyric(){
	...
	function lyric_scroll(){
	    ...
	    $("#lyric_wrapper p").eq($i).css({"color":"#fe2c55f0","transform":"scale(1.1)","text-shadow":"5px 5px 8px #a7a7a7"});
	    $i+=1;
	}
	if(state==1){
		if(n==0){
			$("#lyric_wrapper p").eq(0).css({"color":"#fe2c55f0","transform":"scale(1.1)","text-shadow":"5px 5px 10px #a7a7a7"});
		}
